...
/**
 * Ttmpmetadata entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "ttmpmetadata", schema = "public")

public class Ttmpmetadata implements java.io.Serializable {
	...
	/** minimal constructor */
	public Ttmpmetadata(Integer sercd, String cdoicd, Integer plancd, String orgcd) {
		this.sercd = sercd;
		this.cdoicd = cdoicd;
		this.plancd = plancd;
		this.orgcd = orgcd;
	...
	/** full constructor */
	public Ttmpmetadata(Integer sercd, String cdoicd, Integer plancd, String fcd, String tcd, String syscd,
