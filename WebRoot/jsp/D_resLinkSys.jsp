...
<html>
  <head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/D_resLinkSys.js"></script>
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/css/default.css">	
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/css/D_resLinkSys.css">	
